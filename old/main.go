...
func (g *Game) Draw(screen *ebiten.Image) {
	//画面左
	left_op := &ebiten.DrawImageOptions{}
	left_op.GeoM.Translate(float64(0.0), float64(0.0))
	screen.DrawImage(left_image, left_op)

	//画面右
	right_op := &ebiten.DrawImageOptions{}
	right_op.GeoM.Translate(float64(playAreaRight), float64(0.0))
	screen.DrawImage(right_image, right_op)
